...
\begin{frame}{Três arquiteturas para grandes modelos de linguagem}\justifying
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.6\textwidth}{\centering
        \vspace{1cm}
        \textbf{Espaço para Imagem (Arquiteturas)} \\
        \small\textit{Insira o diagrama das arquiteturas aqui.}
        \vspace{1cm}
      }}
    \end{figure}
\end{frame}
...
\begin{frame}{Codificadores}\justifying
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.5\textwidth}{\centering
        \vspace{0.8cm}
        \textbf{Espaço para Imagem} \\
        \small\textit{Insira o diagrama de Codificadores.}
        \vspace{0.8cm}
      }}
    \end{figure}
\end{frame}
...
\begin{frame}{Codificadores-Decodificadores}\justifying
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.5\textwidth}{\centering
        \vspace{0.8cm}
        \textbf{Espaço para Imagem} \\
        \small\textit{Insira o diagrama Encoder-Decoder.}
        \vspace{0.8cm}
      }}
    \end{figure}
\end{frame}
...
\begin{frame}{Geração Condicional}\justifying
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.8\textwidth}{\centering
        \vspace{1.5cm}
        \textbf{Espaço para Imagem (Geração Condicional)} \\
        \small\textit{Insira a imagem ilustrativa aqui.}
        \vspace{1.5cm}
      }}
    \end{figure}
\end{frame}
...
\begin{frame}{Amostragem por temperatura (1/3)}\justifying
...
\begin{frame}{Amostragem por temperatura (2/3)}\justifying
    \begin{itemize}
...
\begin{frame}{Amostragem por temperatura (3/3)}\justifying
...
\begin{frame}{Algoritmo de treinamento autossupervisionado}\justifying
    ...
    \end{enumerate}
    \vspace{0.5cm}
    Esse paradigma é classificado como aprendizado \textbf{"Autossupervisionado"} porque não requer anotadores humanos; ele simplesmente utiliza a próxima palavra natural no texto como o rótulo definitivo de verdade de base (ground-truth)!
\end{frame}
...
\begin{frame}{Treinando um modelo de linguagem transformer}\justifying
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.8\textwidth}{\centering
        \vspace{1.5cm}
        \textbf{Espaço para Imagem (Treinamento do Transformer)} \\
        \small\textit{Insira o diagrama do fluxo de treinamento aqui.}
        \vspace{1.5cm}
      }}
    \end{figure}
...
\begin{frame}{O Gargalo do Cache KV}\justifying
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.5\textwidth}{\centering
        \vspace{0.5cm}
        \textbf{Espaço para Imagem do Cache KV}
        \vspace{0.5cm}
      }}
    \end{figure}
\end{frame}
...
\begin{frame}{Danos Sociais dos Grandes Modelos de Linguagem}\justifying
    \begin{itemize}
        \item \textbf{Alucinação:} Chatbots rotineiramente 'alucinam' políticas corporativas falsas ou fatos inexistentes.
        \item \textbf{Litígio de Direitos Autorais:} Ações judiciais por infração massiva no uso de obras protegidas durante o treinamento sem permissão.
        \item \textbf{Violações de Privacidade:} Vazamento acidental de e-mails e números de telefone privados extraídos dos dados de treinamento.
        \item \textbf{Toxicidade e Exploração:} O processo de limpeza dos dados muitas vezes exige que humanos avaliem conteúdos tóxicos.
        \item \textbf{Desinformação Política:} Geração de falsidades altamente persuasivas que podem afetar cenários globais e eleições.
    \end{itemize}
\end{frame}
