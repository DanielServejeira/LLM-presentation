...
\begin{frame}
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.5\textwidth}{\centering
        \vspace{0.8cm}
        \textbf{Espaço para Imagem.} \\
        \small\textit{Inserir o diagrama de compressão.}
        \vspace{0.8cm}
      }}
    \end{figure}
    \vspace{2.5cm}
...
\begin{frame}{Alucinação}
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.6\textwidth}{\centering
        \vspace{1cm}
        \textbf{Espaço para Imagem} \\
        \small\textit{Insira a imagem das notícias de alucinação aqui.}
        \vspace{1cm}
      }}
    \end{figure}
\end{frame}
...
\begin{frame}{Litígio de Direitos Autorais}
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.6\textwidth}{\centering
        \vspace{1cm}
        \textbf{Espaço para Imagem} \\
        \small\textit{Insira a imagem das notícias de litígio de direitos autorais aqui.}
        \vspace{1cm}
      }}
    \end{figure}
\end{frame}
...
\begin{frame}{Violações de Privacidade}
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.6\textwidth}{\centering
        \vspace{1cm}
        \textbf{Espaço para Imagem} \\
        \small\textit{Insira a imagem das notícias de violações de privacidade aqui.}
        \vspace{1cm}
      }}
    \end{figure}
\end{frame}
...
\begin{frame}{Toxicidade e Exploração}
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.6\textwidth}{\centering
        \vspace{1cm}
        \textbf{Espaço para Imagem} \\
        \small\textit{Insira a imagem das notícias de toxicidade e exploração aqui.}
        \vspace{1cm}
      }}
    \end{figure}
\end{frame}
...
\begin{frame}{Desinformação Política}
    ...
    \begin{figure}[htbp]
      ...
      \framebox{\parbox{0.6\textwidth}{\centering
        \vspace{1cm}
        \textbf{Espaço para Imagem} \\
        \small\textit{Insira a imagem das notícias de desinformação política aqui.}
        \vspace{1cm}
      }}
    \end{figure}
\end{frame}
